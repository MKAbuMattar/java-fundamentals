...
public class App {
  public static void main(String[] args) {
    ...
    System.out.println("rolling dice: " + Arrays.toString(dices));

    System.out.println("rolling dice has contains Dup: " + containsDuplicates(dices));
    System.out.println("rolling dice calculate Averages: " + calculatingAverages(dices));
    ...
    System.out.println("main arr form arrays of Arrays: " + Arrays.toString(mainArr));
  ...
  public static int[] arraysOfArrays(int[][] arr) {
    ...
    double temp = 2147483647.0;
    for (int[] ints : arr) {
      for (int anInt : ints) {
        sum += anInt;
      }
      avg = (double) (sum) / (double) ((ints.length));
  ...
  public static void tally(List<String> votes) {
    // declare a string value to give it the name with highest votes
    String winner = "";

    // declare an integer value to compare the votes
    int temp = 0;

    // declare an array list to get rid of the duplicated values

    Set<String> getRidOverdub = new HashSet<>(votes);

    for (String vote : getRidOverdub) {
